...
נבדק ב-2026-09-14 — ללא שינוי בשלושה ימים
...
### 2026-09-14 · מודל ממשל הנתונים, ותיקון F-011

- **סטטוס:** קומיט בענף עבודה — לא נדחף לפרודקשן
- **קומיטים:** `8bd1d3b6` שחזור מסמך 03 · `02e9612e` ישות user · `fb8c2b1a` ארבע הישויות הנותרות · תיקון `F-011` (ראה למטה)
- **ענף:** `claude/mifo-project-oq44tl`
- **ריצת deploy:** — (לא נדחף)
...
- **לא בוצע:** `F-007` עד `F-010`, `F-012`, `F-013` — מופו ולא תוקנו. `F-010`
  ממתין להחלטה מוצרית
