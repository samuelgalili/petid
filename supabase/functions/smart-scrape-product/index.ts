...
- category: one of: dry-food, wet-food, treats, toys, grooming, health, food, accessories, collars, leashes, beds, clothing, muzzles, enrichment, bowls, deshedding, tools, crates, kennels, training, flea-tick, medical-protection. Use null if unclear.
...
- PRIORITY RULE: If product name is "Seresto" or contains "Flea & Tick"/"Flea and Tick"/"פרעושים וקרציות", always set category to "flea-tick". Extract protection_duration_months (e.g. 8), active_ingredients as array (e.g. ["Imidacloprid", "Flumethrin"]), species_warning (e.g. "NOT FOR CATS"), min_age_weeks (e.g. 7), and boolean features: water_resistant, odorless, non_greasy. Extract brand carefully (e.g. "Bayer", "Elanco"). If brand is "Bayer" or "Seresto", always enforce species warning and min_age extraction.
