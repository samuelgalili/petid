...
- If the page contains keywords like "training pad", "puppy pad", "pee pad", "פד אילוף", "רפידה", "רפידות", "פדים", "potty", "wee-wee", "absorbent pad" → set category to "potty-training"
