          ...
          {scanResult && (
            <motion.div initial={{ opacity: 0, y: 5 }} animate={{ opacity: 1, y: 0 }} className="space-y-3">
              ...
              <div className="flex items-center justify-between">
                <p className="text-xs font-bold text-foreground">אישור נתונים שזוהו</p>
                <button onClick={handleReset} className="p-1"><X className="w-4 h-4 text-muted-foreground" /></button>
              </div>
              <p className="text-[10px] text-muted-foreground">בדוק את הנתונים שזוהו ואשר לשמירה</p>
              ...
              <div className="flex gap-2 pt-1">
                ...
                <Button size="sm" className="flex-1 h-9 text-xs" onClick={handleConfirmSave} disabled={saving}>
