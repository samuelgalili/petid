    ...
    <>
      <div className="relative my-5">
        ...
        <div className="relative flex justify-center text-xs uppercase">
          <span className="px-3 font-jakarta font-medium text-gray-700 bg-transparent">
            Or continue with
          </span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-3 gap-3">
        ...
        >
          ...
          <span className="text-xs font-jakarta font-semibold text-gray-900">Google</span>
        </motion.button>
        ...
        >
          ...
          <span className="text-xs font-jakarta font-semibold text-gray-900">Facebook</span>
        </motion.button>
        ...
        >
          ...
          <span className="text-xs font-jakarta font-semibold text-gray-900">Instagram</span>
        </motion.button>
      </div>
    </>
  );
