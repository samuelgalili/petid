  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="w-full bg-gradient-to-r from-petid-gold to-amber-500 hover:from-amber-500 hover:to-petid-gold transition-colors flex items-center justify-between px-4 py-3"
      >
