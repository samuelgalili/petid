...
import { ShoppingBag, X, Search, Package } from 'lucide-react';
...
interface StoryProductTaggerProps {
  onTagProduct: (tag: ProductTag) => void;
...
export const StoryProductTagger = ({ 
  onTagProduct, 
  onRemoveTag, 
  tags, 
  isActive, 
  onToggle 
}: StoryProductTaggerProps) => {
  const { user } = useAuth();
