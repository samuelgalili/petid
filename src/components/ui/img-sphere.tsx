...
const SphereImageGrid: React.FC<SphereImageGridProps> = ({
  ...
  const renderImageNode = useCallback((image: ImageData, index: number) => {
    ...
    return (
      <div
        ...
        style={{
          left: `${containerSize / 2 + position.x - imageSize / 2}px`,
          top: `${containerSize / 2 + position.y - imageSize / 2}px`,
          width: `${imageSize}px`,
          height: `${imageSize}px`,
      ...
      >
        <div 
          className="w-full h-full rounded-full overflow-hidden ring-2 ring-white/50 shadow-lg"
          style={{ 
  ...
  const renderSpotlightModal = () => {
    ...
    return (
      ...
      >
        <div
          className="relative max-w-lg w-full bg-background rounded-2xl overflow-hidden animate-scale-in"
        ...
        >
          <div className="relative">
            ...
            <button
              onClick={() => setSelectedImage(null)}
              className="absolute top-3 right-3 w-8 h-8 bg-black/50 rounded-full text-white flex items-center justify-center hover:bg-black/70 transition-all"
            >
              <X className="w-5 h-5" />
            </button>
          </div>
          ...
          {(selectedImage.title || selectedImage.description) && (
            <div className="p-4">
              {selectedImage.title && (
                <h3 className="text-lg font-bold text-foreground mb-1">{selectedImage.title}</h3>
              )}
