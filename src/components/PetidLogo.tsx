...
export const PetidLogo = ({
  ...
  return <div className={className}>
      ...
      <motion.div className="relative flex items-center gap-3" initial={{
        opacity: 0,
        scale: 0.8
      }} animate={{
        opacity: 1,
        ...
        <motion.div className="relative" whileHover={{
          ...
          <motion.div className="absolute inset-0 blur-xl rounded-full" style={{
          ...
          <motion.img src={petidIcon} alt="Petid Icon" className={`${iconSizes[size]} object-contain relative z-10 drop-shadow-lg`} />
        </motion.div>

        {/* Logo image */}
        <motion.div className="relative">
          {/* Warm glow behind logo */}
          <motion.div className="absolute inset-0 blur-2xl rounded-full" style={{
      ...
      {showAnimals && <div className={`flex justify-center items-end gap-4 mb-8 relative ${containerHeights[size]}`}>
          {/* Dog animation */}
          <motion.div initial={{
        x: -150,
        opacity: 0
        ...
        ease: "easeOut"
            ...
            <motion.img src={dogIcon} alt="Dog" className={`${animalSizes[size]} object-contain drop-shadow-md`} animate={{
          y: [0, -5, 0]
        }} transition={{
          duration: 2,
          repeat: Infinity,
          ...
          {/* Heart between pets */}
          <motion.div className="absolute bottom-1/2 left-1/2 transform -translate-x-1/2 z-10" initial={{
        opacity: 0,
        scale: 0
      }} animate={{
        opacity: [0, 1, 1, 0],
        ...
        ease: "easeOut"
            ...
            <motion.img src={catIcon} alt="Cat" className={`${animalSizes[size]} object-contain drop-shadow-md`} animate={{
          y: [0, -5, 0]
        }} transition={{
          duration: 2,
          repeat: Infinity,
