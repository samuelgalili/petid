        ...
        {showUploadMenu && (
          <>
            ...
            <motion.div
              ...
              className="fixed bottom-[80px] left-[calc(50%-60px)] -translate-x-1/2 z-[9999] flex items-center gap-6 px-6 py-4 bg-background/90 backdrop-blur-xl rounded-2xl border border-border/50 shadow-2xl"
              dir="rtl"
            >
              {[
