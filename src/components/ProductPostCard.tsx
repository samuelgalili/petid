...
import { ShoppingBag, Heart, MessageCircle, Send, Bookmark, Tag, ChevronLeft } from "lucide-react";
  ...
  return (
    <article className="bg-card rounded-2xl shadow-card mx-2 my-1 border border-border/20 dark:border-border/10">
      ...
      <div className="flex items-center justify-between px-4 py-3">
        ...
        <PostOptionsMenu
          copyLink={`${window.location.origin}/product/${product.id}`}
          hideLabel="הסתר מוצר"
          hideToast="המוצר הוסתר"
        />
      </div>
