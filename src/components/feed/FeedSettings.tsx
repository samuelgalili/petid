      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className="fixed bottom-0 left-0 right-0 z-[10001] bg-card/95 backdrop-blur-2xl rounded-t-3xl p-5 pb-[calc(env(safe-area-inset-bottom)+80px)] border-t border-border/20 shadow-2xl"
            dir="rtl"
          >
