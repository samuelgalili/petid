...
export const BRAND_PROMISE = {
  ...
  full: "MIPO מלווה בעלי חיות מחמד בכל שלב - מהבחירה הראשונה ועד לתזכורת הבאה. אנחנו לא מוכרים לך - אנחנו דואגים איתך.",
  tagline: "ביחד, דואגים נכון.",
} as const;

// === סיפור המותג ===
export const BRAND_STORY = {
  origin: "MIPO נולד מהבנה פשוטה: בעלי חיות מחמד לא צריכים עוד חנות אונליין. הם צריכים מישהו שיעזור להם לדאוג נכון.",
