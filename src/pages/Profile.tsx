            ...
            stiffness: 300
              ...
              y: 0
                  ...
                  <div className="relative">
                    ...
                    <Input placeholder="חיפוש שירותים..." className="pr-10 h-10 bg-muted/30 border-0 rounded-xl text-sm placeholder:text-muted-foreground/60" />
                  </div>
                </motion.div>
              ...
              <motion.div key="services" className="px-4 space-y-2" initial={{
                opacity: 0
              }} animate={{
                opacity: 1
              }} exit={{
                ...
                duration: 0.15
                  ...
                  id: 'insurance',
                  label: 'ביטוח',
                  subtitle: 'כיסוי מלא לחיית המחמד',
                  icon: Shield,
                  badge: 2
                }, {
                  id: 'boarding',
                  label: 'פנסיון',
                  subtitle: 'טיפול מסביב לשעון',
                  icon: Building2
                }, {
                  id: 'grooming',
                  label: 'טיפוח',
                  subtitle: 'מראה מושלם ובריא',
                  icon: Scissors
                }, {
                  id: 'training',
                  label: 'אילוף',
                  subtitle: 'מאלפים מוסמכים ומנוסים',
                  icon: GraduationCap
                }, {
                  id: 'health',
                  label: 'בריאות',
                  subtitle: 'מעקב וטיפול רפואי',
                  icon: Stethoscope,
                  badge: 1
                }, {
                  id: 'dog_walker',
                  label: 'דוג ווקר',
                  subtitle: 'טיולים יומיים',
                  icon: Footprints
                }].map((service, index) => {
                  const ServiceIcon = service.icon;
                  return <motion.button key={service.id} onClick={() => handleCategoryClick(service.id)} className="w-full flex items-center gap-3 p-3 bg-card/50 hover:bg-card rounded-xl border border-border/20 hover:border-border/40 transition-all group" initial={{
                    opacity: 0,
                    y: 10
                  }} animate={{
                    opacity: 1,
                    ...
                    delay: index * 0.03
                            ...
                            <div className="flex-1 text-right min-w-0">
                              <div className="flex items-center gap-2">
                                ...
                                {service.badge && <span className="w-4 h-4 rounded-full bg-primary text-[10px] font-bold text-primary-foreground flex items-center justify-center">
                                    {service.badge}
                                  </span>}
                              </div>
