  ...
  const sections = [
    {
      ...
      items: [
        "אתר האינטרנט mipo.pet ואפליקציית MIPO מהווים יחד פלטפורמה דיגיטלית אחת ומשולבת המופעלת על ידי יובל דיגיטל, ע.פ. 036574564, להלן החברה.",
    ...
    },
    {
      ...
      title: "2. מהות השירות",
      items: [
        "MIPO פועלת בדומה לרשת חברתית ומאפשרת יצירת פרופילים, שיתוף תכנים, מעקב אחר משתמשים אחרים, פיד תוכן, דירוגים והמלצות.",
    ...
    },
    {
      ...
      items: [
        ...
        "החברה שומרת לעצמה את הזכות לדרוש אימות גיל בכל עת."
      ]
    },
    {
      icon: Lock,
    ...
    },
    {
      ...
      items: [
        ...
        "פרטי כרטיסי האשראי מועברים ישירות לספק הסליקה ואינם עוברים דרך שרתי החברה.",
    ...
    },
    {
      ...
      items: [
        ...
        "אין להסתמך על זיהוי גזע אוטומטי לצורך החלטות רפואיות.",
    ...
    },
    {
      ...
      items: [
        "מידע אישי נשמר בהתאם לדין ולמדיניות הפרטיות המפורטת.",
        "למידע נוסף ראו את מדיניות הפרטיות המלאה באפליקציה.",
      ...
      <div className="max-w-2xl mx-auto px-4 py-6">
        ...
        >
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              <h2 className="text-lg font-bold text-foreground font-jakarta">MIPO</h2>
          ...
          <p className="text-sm text-muted-foreground font-jakarta leading-relaxed">
            השימוש באפליקציית MIPO ובשירותיה כפוף לתנאים המפורטים להלן.
